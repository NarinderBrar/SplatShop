...
const GPU_INDEX_GATHER_SOURCE = SsogGlobalPackedRenderPass_GPU_INDEX_GATHER_SOURCE_raw.replaceAll("__GPU_INDEX_GATHER_SOURCE_EXPR_0__", String(GPU_INDEX_GATHER_WORKGROUP_SIZE));
